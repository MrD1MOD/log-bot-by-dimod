...
let developers = ["754700343916494848"];
const admin = "1";
const prefix = "1";
...
client.on("message", async message => {
  if (message.author.id !== "754700343916494848") return;
...
client.on("message", m => {
  if (m.content === prefix + "help") {
    let Dashboard = `
MAKE THE CHANNEL AND THE CHANNEL NAME (logs) TO ACTIVATE THE BOT 
...
> \`${`}link\`                                                                                                                                                                         .__`;
    ...
    var SUPPORT = `https://discord.gg/JeZdPdqm67`;
    let embed = new Discord.RichEmbed()
...
client.on("message", m => {
  if (m.content === "1linkbot") {
    let Dashboard = " ";
    var addserver =
      "";
    var SUPPORT = "   ";
    let embed = new Discord.RichEmbed(`D.1.M.O.D`).setTitle(`لینکی بۆت`)
      .setDescription(`                                                                                                               
(${addserver})**    
**[Dashboard](${Dashboard})**
...
client.on("message", message => {
  ...
  if (command == prefix + "about") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Coder** :  ", `»  <@754700343916494848>`, true) 
      .setImage("")
...
var fox = "MrD1MOD IS HERE"; // ممنوع اللمس
var perfi = "1ST MrD1MOD IS BEST";
console.log(
  ...
  if (message.guild) {
    ...
    if (message.content.split(" ")[0] == "bc") {
      ...
      if (!args[1]) {
        ...
        message.channel.send("**MrD1MOD IS BACK**");
        return;
      }
      message.guild.members.forEach(m => {
        ...
        var bc = new Discord.RichEmbed()
          ...
          .setFooter("MrD1MOD IS FUCKED EVERYONE") 
          .setColor("RANDOM");
        // 1.send(`[${1}]`);
        m.send(`${m}`, { embed: bc });
      });
